...
public class VagueEnnemy : MonoBehaviour
{
    ...
    private void SpawnEnemiesForWave(int waveIndex_p)
    {
        ...
        if (hudPlayer != null)
        {
            hudPlayer.UpdateWaveText(waveIndex_p + 1); // Mise à jour du texte de la vague
            hudPlayer.UpdateEnemiesRemainingText(enemiesRemaining); // Mise à jour du texte des ennemis restants
        }
